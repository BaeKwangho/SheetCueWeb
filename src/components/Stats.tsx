        ...
        <section id="stats" className="py-8 lg:py-14">
            <div className="sheetcue-stat-grid grid overflow-hidden rounded-[1.75rem] border sm:grid-cols-3">
                {stats.map((stat, index) => (
                    <Reveal key={stat.title} delay={index * 0.08} y={18} className="sheetcue-stat-card mx-auto max-w-md border-b p-6 text-center last:border-b-0 sm:max-w-full sm:border-b-0 sm:border-r sm:text-left sm:last:border-r-0 lg:p-8">
